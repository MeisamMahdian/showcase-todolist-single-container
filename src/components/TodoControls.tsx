  ...
  return (
    <div className="todo-controls">
      <div className="todo-sort-controls">
        ...
        <button className={`todo-sort-btn ${sortBy === "title" ? "active" : ""}`} onClick={() => onSortChange("title")}>
          Title {sortBy === "title" && (sortOrder === "asc" ? "↑" : "↓")}
        </button>
        {dueDateAttribute && (
          <button className={`todo-sort-btn ${sortBy === "date" ? "active" : ""}`} onClick={() => onSortChange("date")}>
