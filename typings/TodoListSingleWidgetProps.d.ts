/**
 * This file was generated from TodoListSingleWidget.xml
...
export interface TodoListSingleWidgetContainerProps {
    name: string;
    class: string;
    style?: CSSProperties;
    tabIndex?: number;
...
export interface TodoListSingleWidgetPreviewProps {
    /**
